// Cotización del dólar tarjeta (oficial + impuestos) desde dolarapi.com.
// API pública, sin API key. Devuelve el valor "venta".

const ENDPOINT = 'https://dolarapi.com/v1/dolares/tarjeta';
...
export async function getDolarTarjeta() {
  ...
  try {
    ...
    // Si falla la API, devolvemos lo último cacheado (si hay) o null.
